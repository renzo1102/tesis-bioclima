...
def ajustar_modelo(data, y, x_vars):
    ...
    tabla = pd.DataFrame({
        ...
        "IC_inf": conf_int["IC_inf"].values,
        "IC_sup": conf_int["IC_sup"].values
    })

    r2 = modelo.rsquared
    r2_adj = modelo.rsquared_adj  # 👈 NUEVO

    return tabla, r2, r2_adj, modelo
...
# 1 NDVI ~ P + T
tabla1, r2_1, r2adj_1, modelo1_matoc = ajustar_modelo(matoc, "ndvi", ["P_mm","Tmed_c"])
tabla1["R2"] = r2_1
tabla1["R2_adj"] = r2adj_1
tabla1.to_csv("resultados/tablas/modelos/modelo1_matoc.csv", index=False)

# 2 Q ~ P + T
tabla2, r2_2, r2adj_2, modelo2_matoc = ajustar_modelo(matoc, "Q_mm", ["P_mm","Tmed_c"])
tabla2["R2"] = r2_2
tabla2["R2_adj"] = r2adj_2
tabla2.to_csv("resultados/tablas/modelos/modelo2_matoc.csv", index=False)

# 3 Q ~ NDVI + P + T
tabla3, r2_3, r2adj_3, modelo3_matoc = ajustar_modelo(matoc, "Q_mm", ["ndvi","P_mm","Tmed_c"])
tabla3["R2"] = r2_3
tabla3["R2_adj"] = r2adj_3
...
# 1 NDVI ~ P + T
tabla4, r2_4, r2adj_4, modelo1_pocco = ajustar_modelo(pocco, "ndvi", ["P_mm","Tmed_c"])
tabla4["R2"] = r2_4
tabla4["R2_adj"] = r2adj_4
tabla4.to_csv("resultados/tablas/modelos/modelo1_pocco.csv", index=False)

# 2 Q ~ P + T
tabla5, r2_5, r2adj_5, modelo2_pocco = ajustar_modelo(pocco, "Q_mm", ["P_mm","Tmed_c"])
tabla5["R2"] = r2_5
tabla5["R2_adj"] = r2adj_5
tabla5.to_csv("resultados/tablas/modelos/modelo2_pocco.csv", index=False)

# 3 Q ~ NDVI + P + T
tabla6, r2_6, r2adj_6, modelo3_pocco = ajustar_modelo(pocco, "Q_mm", ["ndvi","P_mm","Tmed_c"])
tabla6["R2"] = r2_6
tabla6["R2_adj"] = r2adj_6
...
ax[0].set_title(f"Modelo multivariado Matoc (R² = {r2_3:.2f} | R²aj = {r2adj_3:.2f})")
...
ax[1].set_title(f"Modelo multivariado Pocco (R² = {r2_6:.2f} | R²aj = {r2adj_6:.2f})")
...
print("\nR2 Matoc")
print("NDVI ~ P + T =", r2_1, "| R2aj =", r2adj_1)
print("Q ~ P + T =", r2_2, "| R2aj =", r2adj_2)
print("Q ~ NDVI + P + T =", r2_3, "| R2aj =", r2adj_3)

print("\nR2 Pocco")
print("NDVI ~ P + T =", r2_4, "| R2aj =", r2adj_4)
print("Q ~ P + T =", r2_5, "| R2aj =", r2adj_5)
print("Q ~ NDVI + P + T =", r2_6, "| R2aj =", r2adj_6)
